...
import { Funcionarios, FuncionariosService } from './../service/funcionarios.service';
import { FeedService, Feed } from './../service/feed.service';
 ...
 if (this.isUpdate) {
    ...
    this.service.createPnt(pendencia).subscribe(
      ...
      const Mydata = {
        ...
        LargText: 'Quantidade de Batidas Incompletas no ponto do dia: ' +  DateNN + '. Não se esqueça de justificar, para que a correção seja feita e não aconteçam eventuais descontos.',
        SImg: '',
        LImage: '',
      }
