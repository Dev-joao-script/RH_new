...
export class AdvertenciaPage implements OnInit {
  ...
  justtext: any;
  sourseresolve: any;
  url = 'https://www.cepelma.com.br/Api_LC_Advertencia.php';
  SERVER_URL = "https://www.cepelma.com.br/Api_LC_Advertencia.php";
  ...
  uploadFile() {
    ...
    this.ip = this.url + "?id=" + this.valueA + "&Nome=" + this.valueB + "&Periodo=" +
      this.Data + "&Dias=" + this.Dias + "&Tipo=" + this.Tipo + "&Motivo=" + this.Motivo + "&Alinea=" + this.Alinea;
